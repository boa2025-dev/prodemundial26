...
export const BRACKET_MAP: Record<string, BracketEntry> = {
  'R32-1': { s1: '2A', s2: '2B', kickoff: new Date('2026-06-28T19:00Z'), sede: 'SoFi Stadium, Los Ángeles' },
  'R32-2': { s1: '1E', s2: 'T3-1', kickoff: new Date('2026-06-29T20:30Z'), sede: 'Gillette Stadium, Boston' },
  'R32-3': { s1: '1F', s2: '2C', kickoff: new Date('2026-06-30T01:00Z'), sede: 'Estadio BBVA, Guadalupe' },
  'R32-4': { s1: '1C', s2: '2F', kickoff: new Date('2026-06-29T17:00Z'), sede: 'NRG Stadium, Houston' },
  'R32-5': { s1: '1I', s2: 'T3-2', kickoff: new Date('2026-06-30T21:00Z'), sede: 'MetLife Stadium, Nueva York' },
  'R32-6': { s1: '2E', s2: '2I', kickoff: new Date('2026-06-30T17:00Z'), sede: 'AT&T Stadium, Dallas' },
  'R32-7': { s1: '1A', s2: 'T3-3', kickoff: new Date('2026-07-01T01:00Z'), sede: 'Estadio Azteca, Ciudad de México' },
  'R32-8': { s1: '1L', s2: 'T3-4', kickoff: new Date('2026-07-01T16:00Z'), sede: 'Mercedes-Benz Stadium, Atlanta' },
  'R32-9': { s1: '1D', s2: 'T3-5', kickoff: new Date('2026-07-02T00:00Z'), sede: "Levi's Stadium, San Francisco" },
  'R32-10': { s1: '1G', s2: 'T3-6', kickoff: new Date('2026-07-01T20:00Z'), sede: 'Lumen Field, Seattle' },
  'R32-11': { s1: '2K', s2: '2L', kickoff: new Date('2026-07-02T23:00Z'), sede: 'BMO Field, Toronto' },
  'R32-12': { s1: '1H', s2: '2J', kickoff: new Date('2026-07-02T19:00Z'), sede: 'SoFi Stadium, Los Ángeles' },
  'R32-13': { s1: '1B', s2: 'T3-7', kickoff: new Date('2026-07-03T03:00Z'), sede: 'BC Place, Vancouver' },
  'R32-14': { s1: '1J', s2: '2H', kickoff: new Date('2026-07-03T22:00Z'), sede: 'Hard Rock Stadium, Miami' },
  'R32-15': { s1: '1K', s2: 'T3-8', kickoff: new Date('2026-07-04T01:30Z'), sede: 'Arrowhead Stadium, Kansas City' },
  'R32-16': { s1: '2D', s2: '2G', kickoff: new Date('2026-07-03T18:00Z'), sede: 'AT&T Stadium, Dallas' },
  'R16-1': { s1: 'WR32-2', s2: 'WR32-5', kickoff: new Date('2026-07-04T21:00Z'), sede: 'Lincoln Financial Field, Filadelfia' },
  'R16-2': { s1: 'WR32-1', s2: 'WR32-3', kickoff: new Date('2026-07-04T17:00Z'), sede: 'NRG Stadium, Houston' },
  'R16-3': { s1: 'WR32-4', s2: 'WR32-6', kickoff: new Date('2026-07-05T20:00Z'), sede: 'MetLife Stadium, Nueva York' },
  'R16-4': { s1: 'WR32-7', s2: 'WR32-8', kickoff: new Date('2026-07-06T00:00Z'), sede: 'Estadio Azteca, Ciudad de México' },
  'R16-5': { s1: 'WR32-11', s2: 'WR32-12', kickoff: new Date('2026-07-06T19:00Z'), sede: 'AT&T Stadium, Dallas' },
  'R16-6': { s1: 'WR32-9', s2: 'WR32-10', kickoff: new Date('2026-07-07T00:00Z'), sede: 'Lumen Field, Seattle' },
  'R16-7': { s1: 'WR32-14', s2: 'WR32-16', kickoff: new Date('2026-07-07T16:00Z'), sede: 'Mercedes-Benz Stadium, Atlanta' },
  'R16-8': { s1: 'WR32-13', s2: 'WR32-15', kickoff: new Date('2026-07-07T20:00Z'), sede: 'BC Place, Vancouver' },
